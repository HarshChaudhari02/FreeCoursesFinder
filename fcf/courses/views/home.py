...
def index(request):
    ...
    institutes = Institute.get_all_institute()
    for inst in institutes:
        insti_name.append(inst.name)
        insti_img.append(inst.img)

    main_subjects = Main_subject.get_all_main_subject()
    for ms in main_subjects:
        mains.append(ms.name)

    subjects = Sub_subject.get_all_sub_subject()

    data['main_subjects'] = mains
    data['courses'] = courses
    data['institute_name'] = insti_name
    data['institute_img'] = insti_img
